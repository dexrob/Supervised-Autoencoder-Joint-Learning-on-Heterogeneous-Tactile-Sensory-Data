...
'''
sample command: python T1_BT19_Icub_joint_ae_partialB.py -k 0 -c 0 -r 1 --data_dir /home/ruihan/data
...
# new model
# model_name_B = 'BT19_joint_ae_wrB_{}_wcB_{}_wrI_{}_wcI_{}_wC_{}_reductB_{}_{}'.format(w_rB,w_cB, w_rI, w_cI, w_mse, data_reduction_ratio, str(kfold_number))
# model_name_I = 'IcubCNN_joint_ae_wrB_{}_wcB_{}_wrI_{}_wcI_{}_wC_{}_reductB_{}_{}'.format(w_rB,w_cB, w_rI, w_cI, w_mse, data_reduction_ratio, str(kfold_number))
model_name_B = "test_B_partialB"
model_name_I = "test_I_partialB"
...
dict_name = "BT19Icub_joint_ae_partialB_{}_fold{}.pkl".format(data_reduction_ratio, str(kfold_number))
